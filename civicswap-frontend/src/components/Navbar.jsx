...
const Navbar = () => {
  ...
  // 🔥 THE MAGIC FIX: Agar home page nahi hai, toh always dark text use karo!
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span
            className={`text-xl font-bold tracking-tight transition-colors duration-300 ${isLightNav ? "text-black" : "text-white"}`}
          >
            CivicSwap
          </span>
        </Link>
